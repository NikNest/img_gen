...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_generator-msg:<ObjectCount> is deprecated: use image_generator-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_generator-msg:count-val is deprecated.  Use image_generator-msg:count instead.")
  (count m))
